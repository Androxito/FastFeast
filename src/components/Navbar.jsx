...
const Navbar = () => {
  ...
  const navigate = useNavigate();
   const navItems = [
    { id: 1, name: "Menu", path: "/inicio" },
    { id: 2, name: "Programs", path: "/programs" },
    { id: 3, name: "Crear Platillo", path: "/resources" },
    { id: 4, name: "Perfil", path: "/about" },
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2 md:pr-16 pr-0">
              <Link to="/inicio" className="text-lg font-semibold text-sky-700 flex items-center gap-x-2">
    <FiBookOpen size={24} />
    FastFeast
</Link>
            </div>
    ...
    FastFeast
                ...
                <div className="flex-1 flex flex-col md:flex-row items-center justify-between gap-6 p-6 md:p-0">
                    ...
                    onClick={() => navigate("/inicio-sesion")}
                     className="w-fit px-6 py-2 rounded-full text-base text-neutral-800 font-medium bg-transparent transition-colors duration-200 cursor-pointer"
                         >
                    Sign In
                    </button>
                        <button
    onClick={() => navigate("/carrito")}
    className="w-fit px-6 py-2 rounded-lg text-base text-neutral-50 bg-neutral-800 hover:bg-neutral-700 transition-colors duration-200 cursor-pointer"
>
    Ver Carrito
</button>
                    </div>
